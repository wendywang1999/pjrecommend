...
class zhilian:
    ...
    def get_inter(self):
        f = open('table3_action.txt', 'r', encoding='utf-8')
        f_target = open('zhilian.inter', 'w', encoding='utf-8')
        f.readline()
    ...
    def get_user_item(self):
        ...
        f = open('table1_user.txt', 'r', encoding='utf-8')
        f_user = open('zhilian.user', 'w', encoding='utf-8')
        ...
        f = open('table2_jd.txt', 'r', encoding='utf-8')
        f_item = open('zhilian.item', 'w', encoding='utf-8')
        head = f.readline()[:-1].split('\t')
    ...
    def get_docs(self):
        ...
        f = open('table1_user.txt', 'r', encoding='utf-8')
        f.readline()
        f_udoc = open('zhilian.udoc', 'w', encoding='utf-8')
        ...
        f = open('table2_jd.txt', 'r', encoding='utf-8')
        f.readline()
        f_idoc = open('zhilian.idoc', 'w', encoding='utf-8')
